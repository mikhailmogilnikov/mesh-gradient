...
description: "Set up Mesh Gradient in a React app with minimal configuration."
---
...
<Callout>
**Sizing:** set `style`, `className`, or a sized wrapper so the canvas always has a layout box. See [Canvas layout & HiDPI](/docs/advanced-usage#canvas-layout--hidpi).
</Callout>
