---
title: "<MeshGradient /> (React)"
description: "Reference for the React <MeshGradient /> component props, callbacks, and usage patterns."
---
...
<TypeTable
  type={{
    options: {
      description: 'Mesh gradient options passed to core instance.',
      type: 'MeshGradientOptions & MeshGradientInitOptions & MeshGradientUpdateOptions',
      required: false,
    },
    isPaused: {
      description: 'Pause/resume animation loop.',
      type: 'boolean',
      required: false,
      default: false,
    },
    onInit: {
      description: 'Callback fired after instance initialization.',
      type: '(instance: MeshGradient) => void',
      required: false,
    },
    onUpdate: {
      description: 'Callback fired after options update.',
      type: '(instance: MeshGradient) => void',
      required: false,
    },
  }}
