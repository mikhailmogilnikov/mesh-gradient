---
title: "useMeshGradient() (Vue)"
description: "Reference for the Vue useMeshGradient composable, reactive instance access, and advanced control."
---
...
<TypeTable
  type={{
    instance: {
      description: 'Reactive reference to MeshGradient instance or `null` before mount.',
      type: 'Ref<MeshGradient | null>',
      required: true,
    },
  }}
/>
...
<TypeTable
  type={{
    canvasManagement: {
      description: '`useMeshGradient`: manual, `<MeshGradient />`: automatic.',
      type: 'Manual | Automatic',
      required: true,
    },
    lifecycleControl: {
      description: '`useMeshGradient`: full control, `<MeshGradient />`: automatic lifecycle.',
      type: 'Full control | Automatic',
      required: true,
    },
    setupComplexity: {
      description: '`useMeshGradient`: higher, `<MeshGradient />`: lower.',
      type: 'Higher | Lower',
      required: true,
    },
    flexibility: {
      description: '`useMeshGradient`: high, `<MeshGradient />`: medium.',
      type: 'High | Medium',
      required: true,
    },
  }}
