...
description: "Set up Mesh Gradient in a Vue app with minimal configuration."
---
...
<Callout>
**Sizing:** bind `:style`, `class`, or parent layout so the canvas is not sized only by framebuffer attributes. See [Canvas layout & HiDPI](/docs/advanced-usage#canvas-layout--hidpi).
</Callout>
